If the SARIF file is generated by the zaproxy-to-ghas action, you should retrieve the tool information from its output and include it in the SARIF file. Here's how you can modify the Python script to include the tool information provided by the zaproxy-to-ghas action:
